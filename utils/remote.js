...
const SERVICE_NAME = 'org.gnome.Shell.Extensions.CyclopConnect';
const SERVICE_PATH = '/org/gnome/Shell/Extensions/CyclopConnect';
const DEVICE_NAME = 'org.gnome.Shell.Extensions.CyclopConnect.Device';
const DEVICE_PATH = '/org/gnome/Shell/Extensions/CyclopConnect/Device';
...
var Device = GObject.registerClass({
    GTypeName: 'CyclopConnectRemoteDevice',
...
/**
 * A simple proxy wrapper for the CyclopConnect service.
 */
var Service = GObject.registerClass({
    GTypeName: 'CyclopConnectRemoteService',
    Implements: [Gio.DBusInterface],
    Properties: {
