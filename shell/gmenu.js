...
var ListBox = class ListBox extends PopupMenu.PopupMenuSection {
    ...
    constructor(params) {
        ...
        this.box.add_style_class_name('cyclopconnect-list-box');
...
var IconButton = GObject.registerClass({
    GTypeName: 'CyclopConnectShellIconButton',
}, class Button extends St.Button {

    _init(params) {
        super._init({
            style_class: 'cyclopconnect-icon-button',
            can_focus: true,
        });
        Object.assign(this, params);
...
var IconBox = class IconBox extends PopupMenu.PopupMenuSection {
    ...
    constructor(params) {
        ...
        this.box.style_class = 'cyclopconnect-icon-box';
