...
CyclopConnect: ${Config.PACKAGE_VERSION} (${Config.IS_USER ? 'user' : 'system'})
...
async function generateSupportLog(time) {
    try {
        let [file, stream] = Gio.File.new_tmp('cyclopconnect.XXXXXX');
...
var ConnectDialog = GObject.registerClass({
    GTypeName: 'CyclopConnectConnectDialog',
    Template: 'resource:///org/gnome/Shell/Extensions/CyclopConnect/ui/connect-dialog.ui',
    Children: [
...
var Window = GObject.registerClass({
    GTypeName: 'CyclopConnectPreferencesWindow',
    Properties: {
    ...
    Template: 'resource:///org/gnome/Shell/Extensions/CyclopConnect/ui/preferences-window.ui',
    Children: [
        // HeaderBar
    ...
    _restoreGeometry() {
        this._windowState = new Gio.Settings({
            settings_schema: Config.GSCHEMA.lookup(
                'org.gnome.Shell.Extensions.CyclopConnect.WindowState',
                true
            ),
            path: '/org/gnome/shell/extensions/cyclopconnect/preferences/',
        });
        ...
        if (this._about === undefined) {
            this._about = new Gtk.AboutDialog({
                ...
                logo: GdkPixbuf.Pixbuf.new_from_resource_at_scale(
                    '/org/gnome/Shell/Extensions/CyclopConnect/icons/org.gnome.Shell.Extensions.CyclopConnect.svg',
                    128,
                    128,
                    true
                ),
                program_name: 'CyclopConnect',
