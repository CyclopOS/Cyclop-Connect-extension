...
const SectionRow = GObject.registerClass({
    GTypeName: 'CyclopConnectPreferencesSectionRow',
    Template: 'resource:///org/gnome/Shell/Extensions/CyclopConnect/ui/preferences-section-row.ui',
...
const CommandEditor = GObject.registerClass({
    GTypeName: 'CyclopConnectPreferencesCommandEditor',
    Template: 'resource:///org/gnome/Shell/Extensions/CyclopConnect/ui/preferences-command-editor.ui',
    Children: [
...
var Panel = GObject.registerClass({
    GTypeName: 'CyclopConnectPreferencesDevicePanel',
    Properties: {
    ...
    Template: 'resource:///org/gnome/Shell/Extensions/CyclopConnect/ui/preferences-device-panel.ui',
    Children: [
    ...
    _queryApplications(settings) {
        ...
        let ignoreId = 'org.gnome.Shell.Extensions.CyclopConnect.desktop';
