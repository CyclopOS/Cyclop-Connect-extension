...
const ConversationMessage = GObject.registerClass({
    GTypeName: 'CyclopConnectMessagingConversationMessage',
    Template: 'resource:///org/gnome/Shell/Extensions/CyclopConnect/ui/messaging-conversation-message.ui',
...
const Conversation = GObject.registerClass({
    GTypeName: 'CyclopConnectMessagingConversation',
    Properties: {
    ...
    Template: 'resource:///org/gnome/Shell/Extensions/CyclopConnect/ui/messaging-conversation.ui',
    Children: [
        'entry', 'list', 'scrolled',
        'pending', 'pending-box',
    ],
...
const ConversationSummary = GObject.registerClass({
    GTypeName: 'CyclopConnectMessagingConversationSummary',
    Template: 'resource:///org/gnome/Shell/Extensions/CyclopConnect/ui/messaging-conversation-summary.ui',
...
var Window = GObject.registerClass({
    GTypeName: 'CyclopConnectMessagingWindow',
    Properties: {
        'device': GObject.ParamSpec.object(
            'device',
            'Device',
    ...
    Template: 'resource:///org/gnome/Shell/Extensions/CyclopConnect/ui/messaging-window.ui',
    Children: [
        'headerbar', 'infobar',
        'thread-list', 'stack',
    ],
...
var ConversationChooser = GObject.registerClass({
    GTypeName: 'CyclopConnectConversationChooser',
    Properties: {
        'device': GObject.ParamSpec.object(
            'device',
            'Device',
