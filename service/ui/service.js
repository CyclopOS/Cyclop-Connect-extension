...
var DeviceChooser = GObject.registerClass({
    GTypeName: 'CyclopConnectServiceDeviceChooser',
    Properties: {
    ...
    Template: 'resource:///org/gnome/Shell/Extensions/CyclopConnect/ui/service-device-chooser.ui',
...
var ErrorDialog = GObject.registerClass({
    GTypeName: 'CyclopConnectServiceErrorDialog',
    Template: 'resource:///org/gnome/Shell/Extensions/CyclopConnect/ui/service-error-dialog.ui',
    Children: [
        'error-stack',
        'expander-arrow',
        'gesture',
    ...
    _init(error) {
        super._init({
            application: Gio.Application.get_default(),
            title: `CyclopConnect: ${error.name}`,
        });
        this.set_keep_above(true);
