...
var Metadata = {
    label: _('MPRIS'),
    id: 'org.gnome.Shell.Extensions.CyclopConnect.Plugin.MPRIS',
...
var Plugin = GObject.registerClass({
    GTypeName: 'CyclopConnectMPRISPlugin',
...
const PlayerRemote = GObject.registerClass({
    GTypeName: 'CyclopConnectMPRISPlayerRemote',
    ...
    async export() {
        try {
            ...
            this._ownerId = Gio.bus_own_name_on_connection(
                this._connection,
                `org.mpris.MediaPlayer2.CyclopConnect.${name}`,
